  ...
  return (
    <div className="min-h-screen bg-white px-4 py-10">
      <div className="max-w-2xl mx-auto p-6 text-left">
        ...
        <p className="text-gray-600 mb-8">몇 가지 질문에 답하고, 당신의 입맛 유형과 추천 음식을 확인해보세요 🍽️</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Button onClick={() => navigate('/taste-test')} variant="primary">기본 테스트 하러가기</Button>
          <Button onClick={() => navigate('/taste-detail')} variant="secondary">세부 검사 하러가기</Button>
        </div>
      </div>
    </div>
  );
